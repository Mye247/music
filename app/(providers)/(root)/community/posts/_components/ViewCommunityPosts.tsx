...
function ViewCommunityPosts() {
  ...
  return (
    <div className="bg-gray-900 text-gray-200 p-6 rounded-lg h-screen w-screen">
      <h2 className="text-3xl font-bold pl-3 pt-3">Posts</h2>
      <div className="flex gap-3 justify-end mb-4 pr-3">
        {/* 정렬 옵션 */}
        <p
